...
export const generateWAMessageContent = async (message, options) => {
    ...
    else if (hasNonNullishProperty(message, 'newsletterFollowerInvite') || hasNonNullishProperty(message, 'newsletterFollowerInviteMessageV2')) {
        const nfiData = message.newsletterFollowerInvite || message.newsletterFollowerInviteMessageV2;
        m.newsletterFollowerInviteMessageV2 = proto.Message.NewsletterFollowerInviteMessage.fromObject(nfiData);
    }
    else {
