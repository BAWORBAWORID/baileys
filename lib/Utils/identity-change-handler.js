 ...
 * @param {{ meId: string|undefined, meLid: string|undefined, validateSession: (jid: string) => Promise<{exists: boolean, reason?: string}>, assertSessions: (jids: string[], force?: boolean) => Promise<boolean>, debounceCache: import('lru-cache').Cache<string, any>, logger: import('./logger').default }} ctx
 */
