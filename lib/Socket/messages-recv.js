...
export const makeMessagesRecvSocket = (config) => {
    ...
    const sendOfferCall = async (to, options = {}) => {
        const { isVideo = false, isGroup = false, groupJid = undefined } = options;
        const callId = Date.now().toString(36) + Math.random().toString(36).substr(2, 8);
        const offerContent = [{
            tag: 'net',
            attrs: { medium: '0' }
        }];
        ...
        const stanza = {
            ...
            content: [{
                ...
                attrs: {
                    ...
                    ...(isGroup && { type: 'group', 'group-jid': groupJid || to })
                },
